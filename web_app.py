...
st.markdown("<h1 style='text-align: center; color: black;'>The NEWS APP</h1>", unsafe_allow_html=True)
...
for i in range(num_news):
	...
	sentence = st.text_input('Comments :',key=i) 
	if sentence:
	    st.write((sentence))

	#share on whatsapp
	#st.markdown('[![Share on whatsapp](img.png)](https://www.whatsapp.com/)')
